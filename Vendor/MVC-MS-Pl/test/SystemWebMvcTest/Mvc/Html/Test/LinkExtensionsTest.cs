namespace System.Web.Mvc.Html.Test {
    ...
    public class LinkExtensionsTest {
        ...
        public void ActionLinkDictionaryOverridesImplicitValues() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a href=""http://foo.com"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void ActionLinkExplictValuesOverrideDictionary() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a href=""" + AppPathModifier + @"/app/home/explicitAction"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void ActionLinkParametersNeedEscaping() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a href=""" + AppPathModifier + @"/app/home/new%20action%3C&amp;%3E%22"">linktext&lt;&amp;&gt;&quot;</a>", html.ToHtmlString());
        }
        ...
        public void ActionLinkWithActionNameAndValueDictionary() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a href=""" + AppPathModifier + @"/app/home2/newaction"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void ActionLinkWithControllerNameAndDictionary() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a baz=""baz"" href=""" + AppPathModifier + @"/app/home2/newaction/someid"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void ActionLinkWithFragment() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a baz=""baz"" href=""http://foo.bar.com" + AppPathModifier + @"/app/home2/newaction/someid#foo"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void ActionLinkWithNullHostname() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a baz=""baz"" href=""https://localhost" + AppPathModifier + @"/app/home2/newaction/someid#foo"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void ActionLinkWithNullProtocolAndFragment() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a baz=""baz"" href=""http://foo.bar.com" + AppPathModifier + @"/app/home2/newaction/someid"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void ActionLinkWithProtocol() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a baz=""baz"" href=""https://foo.bar.com" + AppPathModifier + @"/app/home2/newaction/someid"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void ActionLinkWithProtocolAndFragment() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a baz=""baz"" href=""https://foo.bar.com" + AppPathModifier + @"/app/home2/newaction/someid#foo"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void ActionLinkWithNonDefaultPortAndSameProtocol() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a baz=""baz"" href=""http://foo.bar.com:32768" + AppPathModifier + @"/app/home2/newaction/someid#foo"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void RouteLinkCanUseNamedRouteWithoutSpecifyingDefaults() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a href=""" + AppPathModifier + @"/app/any/url"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void RouteLinkWithFragment() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a baz=""baz"" href=""http://foo.bar.com" + AppPathModifier + @"/app/named/home2/newaction/someid#foo"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void RouteLinkWithProtocol() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a baz=""baz"" href=""https://foo.bar.com" + AppPathModifier + @"/app/named/home2/newaction/someid"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void RouteLinkWithProtocolAndFragment() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a baz=""baz"" href=""https://foo.bar.com" + AppPathModifier + @"/app/named/home2/newaction/someid#foo"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void RouteLinkWithRouteNameAndDefaults() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a href=""" + AppPathModifier + @"/app/named/home/newaction"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void RouteLinkWithRouteNameAndDictionary() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a href=""" + AppPathModifier + @"/app/named/home2/newaction/someid"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void RouteLinkWithRouteNameAndObjectProperties() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a baz=""baz"" href=""" + AppPathModifier + @"/app/named/home2/newaction/someid"">linktext</a>", html.ToHtmlString());
        }
    }
}
