namespace System.Web.Mvc.Test {
    ...
    public class ReflectedParameterDescriptorTest {
        ...
        public void DefaultValuePropertyDefaultsToNull() {
            ...
            // Assert
            Assert.IsNull(pd.DefaultValue, "DefaultValue should have been null.");
        }
        ...
        [TestMethod]
        public void DefaultValuePropertyIsReadSecondlyFromDefaultValueAttribute() {
            // Arrange
            ...
            // Assert
            Assert.AreEqual("someValue", pd.DefaultValue);
        }

        [TestMethod]
        public void DefaultValuePropertyRespectsNullRawDefaultValue() {
            // Arrange
            Mock<ParameterInfo> mockPInfo = new Mock<ParameterInfo>() { DefaultValue = DefaultValue.Mock };
