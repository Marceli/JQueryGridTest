namespace System.Web.Mvc.Test {
    ...
    public class HtmlHelperTest {
        ...
        public void EnableClientValidation() {
            ...
            // Act & assert
            Assert.IsFalse(htmlHelper.ClientValidationEnabled, "Client validation should not be enabled by default.");
            htmlHelper.EnableClientValidation();
            Assert.IsTrue(htmlHelper.ClientValidationEnabled, "EnableClientValidation() should have set the client validation flag.");
        }
        ...
        [TestMethod]
        public void FormGeneratorProperty() {
            // Arrange
            Mock<ViewContext> mockViewContext = new Mock<ViewContext>();
            mockViewContext.Expect(c => c.HttpContext.Items).Returns(new Hashtable());

            HtmlHelper htmlHelper = new HtmlHelper(mockViewContext.Object, new Mock<IViewDataContainer>().Object);

            // Act
            string form0Name = htmlHelper.FormIdGenerator();
            string form1Name = htmlHelper.FormIdGenerator();
            string form2Name = htmlHelper.FormIdGenerator();
        ...
        public void NullPartialViewNameThrows() {
            ...
            ExceptionHelper.ExpectArgumentExceptionNullOrEmpty(
                () => helper.RenderPartialInternal(null /* partialViewName */, null /* viewData */, null /* model */, null /* writer */),
                "partialViewName");
        }
        ...
        public void EmptyPartialViewNameThrows() {
            ...
            // Act & Assert
            ExceptionHelper.ExpectArgumentExceptionNullOrEmpty(
                () => helper.RenderPartialInternal(String.Empty /* partialViewName */, null /* viewData */, null /* model */, null /* writer */),
                "partialViewName");
        }
        ...
        public void EngineLookupSuccessCallsRender() {
            // Arrange
            TestableHtmlHelper helper = TestableHtmlHelper.Create();
            TextWriter writer = helper.ViewContext.HttpContext.Response.Output;
        ...
        public void EngineLookupFailureThrows() {
            ...
            ExceptionHelper.ExpectInvalidOperationException(
                () => helper.RenderPartialInternal("partial-view", null /* viewData */, null /* model */, null /* writer */, engine.Object),
...
location2");
        ...
        public void RenderPartialInternalWithNullModelAndNullViewData() {
            ...
            engine
                ...
                .Verifiable();
            view
                .Expect(v => v.Render(It.IsAny<ViewContext>(), null))
                .Callback<ViewContext, TextWriter>(
                    (viewContext, writer) => {
        ...
        public void RenderPartialInternalWithNonNullModelAndNullViewData() {
            ...
            // Act
            helper.RenderPartialInternal("partial-view", null /* viewData */, newModel, null /* writer */, engine.Object);
        ...
        public void RenderPartialInternalWithNullModelAndNonNullViewData() {
            ...
            // Act
            helper.RenderPartialInternal("partial-view", vdd, null /* model */, null /* writer */, engine.Object);
        ...
        public void RenderPartialInternalWithNonNullModelAndNonNullViewData() {
            ...
            // Act
            helper.RenderPartialInternal("partial-view", vdd, newModel, null /* writer */, engine.Object);
