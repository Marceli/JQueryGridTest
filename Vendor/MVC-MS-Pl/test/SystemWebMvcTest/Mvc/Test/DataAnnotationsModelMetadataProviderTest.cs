namespace System.Web.Mvc.Test {
    ...
    public class DataAnnotationsModelMetadataProviderTest {
        ...
        [TestMethod]
        public void HiddenAttributeSetsTemplateHintAndHideSurroundingChrome() {
            // Arrange
            DataAnnotationsModelMetadataProvider provider = new DataAnnotationsModelMetadataProvider();
            ...
            Assert.IsFalse(noAttributeMetadata.HideSurroundingChrome);
            ...
            Assert.IsFalse(defaultHiddenMetadata.HideSurroundingChrome);
            ...
            Assert.IsTrue(hiddenWithDisplayValueFalseMetadata.HideSurroundingChrome);
        ...
        public void DataTypeAttributeSetsDataType() {
            ...
            // Act & Assert
            Assert.IsNull(provider.GetMetadataForProperty(null, typeof(DataTypeModel), "NoAttribute").DataType);
            Assert.AreEqual("EmailAddress", provider.GetMetadataForProperty(null, typeof(DataTypeModel), "EmailAddressProperty").DataType);
            Assert.AreEqual("CustomDataType", provider.GetMetadataForProperty(null, typeof(DataTypeModel), "CustomDataTypeProperty").DataType);
        }
