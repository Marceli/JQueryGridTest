namespace Microsoft.Web.Mvc.Test {
    ...
    public class ExpressionInputExtensionsTest {
        ...
        public void TextboxForWithExpressionRendersInputTagUsingExpression() {
            ...
            // Act
            MvcHtmlString result = htmlHelper.TextBoxFor(p => p.ProductName);

            // Assert
            Assert.AreEqual("<input id=\"ProductName\" name=\"ProductName\" type=\"text\" value=\"ASP.NET MVC\" />", result.ToHtmlString());
        }
        ...
        public void TextboxForWithExpressionRendersInputTagUsingExpressionUsingValueFromModelState() {
            ...
            // Assert
            Assert.AreEqual("<input id=\"ProductName\" name=\"ProductName\" type=\"text\" value=\"Something Else\" />", result.ToHtmlString());
        }
        ...
        public void TextboxForWithExpressionRendersInputTagUsingExpressionUsingValueFromViewState() {
            ...
            // Assert
            Assert.AreEqual("<input id=\"ProductName\" name=\"ProductName\" type=\"text\" value=\"Not Something Else\" />", result.ToHtmlString());
        }
        ...
        public void TextboxForWithExpressionRendersInputTagUsingExpressionWithIntProperty() {
            ...
            // Act
            MvcHtmlString result = htmlHelper.TextBoxFor(p => p.Id);

            // Assert
            Assert.AreEqual("<input id=\"Id\" name=\"Id\" type=\"text\" value=\"123\" />", result.ToHtmlString());
        }
        ...
        public void TextboxForWithExpressionContainingMethodCallRendersInputTagUsingExpressionProperty() {
            ...
            // Act
            MvcHtmlString result = htmlHelper.TextBoxFor(p => p.Id.ToString());
        ...
        public void TextboxForWithAttributesAndExpressionRendersAttributes() {
            ...
            // Act
            MvcHtmlString result = htmlHelper.TextBoxFor(p => p.ProductName, new { width = 123, maxlength = 99 });

            // Assert
            Assert.AreEqual("<input id=\"ProductName\" maxlength=\"99\" name=\"ProductName\" type=\"text\" value=\"ASP.NET MVC\" width=\"123\" />", result.ToHtmlString());
        }
        ...
        public void HiddenForWithExpressionRendersInputTagUsingExpression() {
            ...
            // Act
            MvcHtmlString result = htmlHelper.HiddenFor(p => p.ProductName);

            // Assert
            Assert.AreEqual("<input id=\"ProductName\" name=\"ProductName\" type=\"hidden\" value=\"ASP.NET MVC\" />", result.ToHtmlString());
        }
        ...
        public void HiddenForWithExpressionRendersInputTagUsingExpressionUsingValueFromModelState() {
            ...
            // Assert
            Assert.AreEqual("<input id=\"ProductName\" name=\"ProductName\" type=\"hidden\" value=\"Something Else\" />", result.ToHtmlString());
        }
        ...
        public void HiddenForWithAttributesAndExpressionRendersAttributes() {
            ...
            // Act
            MvcHtmlString result = htmlHelper.HiddenFor(p => p.ProductName, new { @class = "test-css-class" });

            // Assert
            Assert.AreEqual("<input class=\"test-css-class\" id=\"ProductName\" name=\"ProductName\" type=\"hidden\" value=\"ASP.NET MVC\" />", result.ToHtmlString());
        }
...
<option value=""option_2"">option 2</option>
        ...
        public void DropDownListWithOptionLabelAndSelectedIdInModelStateRendersSelectedOption() {
            ...
            // Act
            MvcHtmlString result = htmlHelper.DropDownListFor(p => p.CategoryId, selectList, "Select One");
...
<option selected=""selected"" value=""2"">option 2</option>
        ...
        public void DropDownListForWithAttributesAndExpressionRendersOptionsAndAttributes() {
            ...
            // Act
            MvcHtmlString result = htmlHelper.DropDownListFor(p => p.CategoryId, selectList, new { @class = "test-css-class" });
...
<option value=""2"">option 2</option>
        ...
        public void ValidationMessageForWithNoErrorReturnsNull() {
            ...
            // Act
            MvcHtmlString html = htmlHelper.ValidationMessageFor(p => p.ProductName);
        ...
        public void ValidationMessageForDisplaysErrorMessageInModelState() {
            ...
            // Assert
            Assert.AreEqual(@"<span class=""field-validation-error"">Error Will Robinson!</span>", html.ToHtmlString());
        }
        ...
        public void ValidationMessageForDisplaysSpecifiedErrorMessage() {
            ...
            // Act
            MvcHtmlString html = htmlHelper.ValidationMessageFor(p => p.ProductName, "Error Will Robinson!");
        ...
        public void ValidationMessageForWithAttributesRendersAttribute() {
            ...
            // Act
            MvcHtmlString html = htmlHelper.ValidationMessageFor(p => p.ProductName, "Error Will Robinson!", new { title = "Error!"});

            // Assert
            Assert.AreEqual(@"<span class=""field-validation-error"" title=""Error!"">Error Will Robinson!</span>", html.ToHtmlString());
        }
