namespace System.Web.Mvc {
    ...
    public class ReflectedActionDescriptor : ActionDescriptor {
        ...
        private static IEnumerable<FilterAttribute> RemoveOverriddenFilters(IEnumerable<FilterAttribute> filters) {
            ...
            for (int i = 0; i < filtersList.Length; i++) {
                ...
                if (attrsIndexes.TryGetValue(filterType, out lastIndex)) {
                    ...
                    AttributeUsageAttribute usageAttr = ((AttributeUsageAttribute[])filterType.GetCustomAttributes(typeof(AttributeUsageAttribute), true))[0];
                    attrsIndexes[filterType] = (usageAttr.AllowMultiple) ? -1 : i;
                }
            }
