    ...
    public class ViewDataDictionary : IDictionary<string, object> {
        ...
        internal static class ViewDataEvaluator {
            ...
            private static ViewDataInfo GetIndexedPropertyValue(object indexableObject, string key) {
                ...
                TryGetValueDelegate tgvDel = TypeHelpers.CreateTryGetValueDelegate(indexableType);
                if (tgvDel != null) {
                    object value;
                    if (tgvDel(indexableObject, key, out value)) {
                ...
                if (info != null) {
                    return new ViewDataInfo() {
                        Container = indexableObject,
                        Value = info.GetValue(indexableObject, new object[] { key })
                    };
                }
                ...
                if (objectInfo != null) {
                    return new ViewDataInfo() {
                        Container = indexableObject,
                        Value = objectInfo.GetValue(indexableObject, new object[] { key })
                    };
                }
                return null;
            }
