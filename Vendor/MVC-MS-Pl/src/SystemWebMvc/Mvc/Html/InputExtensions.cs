namespace System.Web.Mvc.Html {
    ...
    public static class InputExtensions {
        ...
        public static MvcHtmlString Hidden(this HtmlHelper htmlHelper, string name, Binary value) {
            return Hidden(htmlHelper, name, value.ToArray());
        }

        public static MvcHtmlString Hidden(this HtmlHelper htmlHelper, string name, byte[] value) {
            return Hidden(htmlHelper, name, Convert.ToBase64String(value));
        }

        public static MvcHtmlString Hidden(this HtmlHelper htmlHelper, string name) {
            return Hidden(htmlHelper, name, (object)null /* value */);
        }
        ...
        private static MvcHtmlString InputHelper(this HtmlHelper htmlHelper, InputType inputType, string name, object value, bool useViewData, bool isChecked, bool setId, bool isExplicitValue, IDictionary<string, object> htmlAttributes) {
