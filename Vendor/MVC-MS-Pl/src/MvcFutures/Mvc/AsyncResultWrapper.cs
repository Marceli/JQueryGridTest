namespace Microsoft.Web.Mvc {
    ...
    public static class AsyncResultWrapper {
        ...
        private class AsyncResultWrapperImpl<TResult> : IAsyncResult {
            ...
            private readonly SingleEntryGate _executeEndDelegateOnceGate = new SingleEntryGate();
            private readonly SingleEntryGate _executeProvidedCallbackDelegateGate = new SingleEntryGate();
            ...
            public TResult ExecuteEndDelegateOnce() {
                if (!_executeEndDelegateOnceGate.TryEnter()) {
